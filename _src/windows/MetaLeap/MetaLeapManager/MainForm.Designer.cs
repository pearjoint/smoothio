namespace MetaLeapManager {
	partial class MainForm {
		...
		private void InitializeComponent () {
			...
			this.instanceEditor1 = new MetaLeapManager.InstanceEditor ();
			this.openFileDialog1 = new System.Windows.Forms.OpenFileDialog ();
			this.instanceSummary1 = new MetaLeapManager.InstanceSummary ();
			this.instanceSummary2 = new MetaLeapManager.InstanceSummary ();
			...
			// serviceController
			// 
			this.serviceController.ServiceName = "MetaLeapService";
			// 
			// toolStrip
			// 
			...
			this.toolStatusDropDown.Image = global::MetaLeapManager.Properties.Resources.img_Service_Pending;
			...
			this.toolStatusStartItem.Image = global::MetaLeapManager.Properties.Resources.img_Service_Running;
			this.toolStatusStartItem.Name = "toolStatusStartItem";
			// 
			// toolStatusStopItem
			// 
			resources.ApplyResources (this.toolStatusStopItem, "toolStatusStopItem");
			this.toolStatusStopItem.Image = global::MetaLeapManager.Properties.Resources.img_Service_Stopped;
			...
			this.toolStatusRestartItem.Image = global::MetaLeapManager.Properties.Resources.img_Service_Restart;
