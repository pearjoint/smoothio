...
,	"h_config_db_host"	:	"In embedded mode, this is always 127.0.0.1.\n\nIn external mode, specify the IP address or host name of the external MongoDB server. (If the external MongoDB server runs on this machine, you may also specify localhost but not 127.0.0.1.)"
,	"config_db_port"	:	"Port"
...
,	"config_min"		:	"Client files"
,	"h_config_min"		:	"Minifying the merged client-side CSS/JS files delays the start-up time of this instance by about 1-3 seconds, but shrinks the total size of the script and stylesheet files initially loaded by clients by over 50%, resulting in a much faster initial load time and reduced load on this instance.\n\nKeeping this setting activated is therefore highly recommended for production servers. Only turn this setting off in development environments for script debugging purposes."
,	"config_minl"		:	"Minify merged client-side CSS/JS files"
...
,	"config_sr_host"	:	"Host address"
,	"h_config_sr_host"	:	"Specify the host address this server should accept connections at. This needs to be an IP address, host name or domain name that this machine can bind to in the current network configuration."
,	"config_sr_port"	:	"Port"
,	"h_config_sr_port"	:	"Specify the TCP port this server should accept connections at. This can be any value greater than zero and lower than 65536. Depending on the operating system installed, using the standard HTTP port number 80 may require special permissions."
,	"config_sr_name"	:	"Server name"
,	"h_config_sr_name"	:	"Specify the name of this server. CAUTION: this is also the name for the content database used by this server UNLESS you specified a different database name below."
,	"config_sr_db"		:	"Database name"
,	"h_config_sr_db"	:	"Specify a custom content database name for this server here, or leave blank to use the server name as the name for its content database (recommended)."
,	"config_sr_active"	:	"This server is enabled/active"
,	"config_sr_dbc"		:	"Use a different content database name"
