  ...
  */  var smio, smoothio;
  ...
  smio.Packs_Core_Controls_Smoothio = (function() {
    ...
    Packs_Core_Controls_Smoothio.prototype.renderHtml = function($el) {
      ...
      __r.p(this.renderTag("r", "maintemplate_loading", null));
